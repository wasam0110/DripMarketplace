...
class User(UUIDPrimaryKeyMixin, AuditMixin, Base):
    ...
    role:               Mapped[UserRole]       = mapped_column(
                            ...
                            nullable=False, default=UserRole.customer, server_default="customer",
                        )
    first_name:         Mapped[str | None]     = mapped_column(String(100), nullable=True)
    last_name:          Mapped[str | None]     = mapped_column(String(100), nullable=True)
    phone:              Mapped[str | None]     = mapped_column(String(20),  nullable=True)
    avatar_url:         Mapped[str | None]     = mapped_column(String(500), nullable=True)
    has_verified_email: Mapped[bool]           = mapped_column(Boolean, nullable=False, default=False, server_default="false")
